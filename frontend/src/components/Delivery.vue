...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="DeliveryDt" v-model="value.deliveryDt"/>
          </div>
          <div class="grey--text ml-4" v-else>
            DeliveryDt :  {{value.deliveryDt }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="ZipCd" v-model="value.zipCd"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ZipCd :  {{value.zipCd }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="AddrNm" v-model="value.addrNm"/>
          </div>
          <div class="grey--text ml-4" v-else>
            AddrNm :  {{value.addrNm }}
          </div>
