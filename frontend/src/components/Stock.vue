...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="StockQty" v-model="value.stockQty"/>
          </div>
          <div class="grey--text ml-4" v-else>
            StockQty :  {{value.stockQty }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="ReserveQty" v-model="value.reserveQty"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ReserveQty :  {{value.reserveQty }}
          </div>
