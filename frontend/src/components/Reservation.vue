...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="ReserveId" v-model="value.reserveId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ReserveId :  {{value.reserveId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="BikeId" v-model="value.bikeId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            BikeId :  {{value.bikeId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="BikeNm" v-model="value.bikeNm"/>
          </div>
          <div class="grey--text ml-4" v-else>
            BikeNm :  {{value.bikeNm }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="UserNm" v-model="value.userNm"/>
          </div>
          <div class="grey--text ml-4" v-else>
            UserNm :  {{value.userNm }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="ReserveStore" v-model="value.reserveStore"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ReserveStore :  {{value.reserveStore }}
          </div>

          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="ReserveDt" v-model="value.reserveDt"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ReserveDt :  {{value.reserveDt }}
          </div>
